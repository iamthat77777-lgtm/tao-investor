...
>
> **A) Follow Lewis's exact strategy** — this is based on the research of Mark Jeffrey, one of the most respected analysts in the Bittensor ecosystem. Lewis used this to deploy £20,000 and you can see his live results on the 10x Dashboard (link in description). Note: short-term results in crypto can be highly misleading — crypto markets are volatile and past performance is not indicative of future results. This allocation is a reasonable starting point for someone new to Bittensor, but it is not a guarantee of returns.
>
> **B) Follow a different researcher or content creator** — maybe you've been watching someone else in the Bittensor space, or you've done your own research and have a different view on which subnets are going to win. We can build your system around that.
>
...
### Step 3: If Option B (different researcher or creator)

Ask:

> "Who has inspired your thinking? It could be a YouTuber, a Twitter/X account, someone from the Bittensor Discord — anyone whose research you trust.
>
> Tell me their name and, if you know it, which subnets they recommend and in what proportions. If you're not sure of the exact numbers, just tell me the names or subnet numbers and I'll help you figure out the rest."

Based on their answer:
- If they give you subnet IDs and percentages → use them directly
- If they give you a researcher name but no specifics → say: "I don't have live access to their research, but you can find their recommended subnets on taostats.io or in their content. Once you have the subnet numbers (they'll look like SN4, SN64 etc.) and validator hotkeys, come back and we'll plug them in. Alternatively, I can build the system with Lewis's allocation as a placeholder and you can update it later."
- If they're unsure → suggest defaulting to Option A as a starting point
...
>
> Take your time. If you're not sure about any of this, I'd recommend starting with Option A (Lewis's allocation) and customising it later once you've seen how the system works."
